...
import com.example.agenda.ui.sqliteDb.DbGateway;
...
public class ContatosDAO {
    ...
    public List<Contatos> buscarTodosOsDados(long raBusca, int statusBusca){
        List<Contatos> contacts = new ArrayList<>();
        String selectQuery = "SELECT * FROM "+DB_TABLE+" WHERE RA = " + raBusca + " AND Status = " + statusBusca;
